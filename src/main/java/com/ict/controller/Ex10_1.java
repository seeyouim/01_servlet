...
public class Ex10_1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// JSP에 out 내장 객체가 존재 하는데 같은 기능을 한다.
		...
		//			  새로운 request와 response 가 만들어진다.
		//			  즉, 파라미터 값들이 최종 페이지에서는 사라진다.
		//			  주소창에서는 최종 주소가 보인다.
		// 사용법 : response.sendRedirect("이동 할 주소");
		//			이동 할 주소가 servlet이면 확장자를 사용하지 않는다.
		//		    이동 할 주소가 html이면 확장자를 사용한다.
